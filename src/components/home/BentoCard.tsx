...
const BentoCard: React.FC<BentoCardProps> = ({ icon: Icon , title, description }) => {
    return (
        <div className="relative overflow-hidden rounded-xl bg-white dark:bg-neutral-900 p-6 hover:scale-[1.02] transition-all duration-300 hover:shadow-xl hover:shadow-fuchsia-200 dark:hover:shadow-fuchsia-950 group">
